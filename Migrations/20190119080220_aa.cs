        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Quantity = table.Column<int>(nullable: false),
                    CreatedAt = table.Column<DateTime>(nullable: false),
                    MaterialStockId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DailyMaterialsUsed", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DailyMaterialsUsed_MaterialStocks_MaterialStockId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DailyStocks_Customers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Customers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Quantity = table.Column<int>(nullable: false),
                    CustomerId = table.Column<int>(nullable: false),
                    DailyStockId = table.Column<int>(nullable: false),
                    CreatedAt = table.Column<DateTime>(nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Sales_DailyStocks_DailyStockId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DailyMaterialsUsed_MaterialStockId",
                table: "DailyMaterialsUsed",
                column: "MaterialStockId");

            migrationBuilder.CreateIndex(
                name: "IX_DailyStocks_CustomerId",
                table: "DailyStocks",
                column: "CustomerId");
